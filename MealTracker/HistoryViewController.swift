...
extension HistoryViewController: HistoryPhotoViewCellDelegate{
    ...
    func alertAction(historyPhotoCell: HistoryPhotoViewCell) {
        ...
        (alert: UIAlertAction!) -> Void in
            ...
            //print("Share")
            SEGAnalytics.sharedAnalytics().screen("Tapped Share in Edit Meal Menu")
        ...
        (alert: UIAlertAction!) -> Void in
            ...
            SEGAnalytics.sharedAnalytics().screen("Tapped Edit Meal in History")
        ...
        (alert: UIAlertAction!) -> Void in
            ...
            SEGAnalytics.sharedAnalytics().screen("Tapped Edit Time in Edit Meal Menu")
