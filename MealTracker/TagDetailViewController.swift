...
class TagDetailViewController: UIViewController{
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        SEGAnalytics.sharedAnalytics().screen("Nutrition Guide")
...
extension TagDetailViewController: UITableViewDelegate {
    ...
    func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        ...
        case .Some(_) where expandedIndexPath == indexPath:
            SEGAnalytics.sharedAnalytics().track("Collapsed Nutrition Info in Guide", properties: ["tagName": gArrDescription[expandedIndexPath!.row]])
            expandedIndexPath = nil
        case .Some(let expandedIndex) where expandedIndex != indexPath:
            expandedIndexPath = nil
            SEGAnalytics.sharedAnalytics().track("Expanded Nutrition Info in Guide", properties: ["tagName": gArrDescription[indexPath.row]])
