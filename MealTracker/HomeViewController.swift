...
class HomeViewController: UIViewController{
    ...
    override func viewWillAppear(animated: Bool) {
        ...
        if gHomeDelegate == true{
            SEGAnalytics.sharedAnalytics().screen("Camera")
        }
    }
    ...
    @IBAction func onTouchPhotoGalleryButton(){
        SEGAnalytics.sharedAnalytics().track("Tapped Import from Camera Roll on Home")
    ...
    @IBAction func onTouchPhotoShutter(){
        ...
        mPhotoCamera.capturePhotoAsJPEGProcessedUpToFilter(mCropFilter) { (processedJPEG, error) -> Void in
           ...
           // print(cameraView.bounds.height)
            ...
            SEGAnalytics.sharedAnalytics().screen("Tag Editor", properties: ["Source": "Create Meal"])
