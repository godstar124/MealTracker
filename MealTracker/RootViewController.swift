...
class RootViewController: UIViewController{
    ...
    @IBAction func onTerms(){
       let vc = self.storyboard?.instantiateViewControllerWithIdentifier("vcTermsViewController") as? TermsViewController
        ...
        SEGAnalytics.sharedAnalytics().screen("Terms Screen")
    ...
    @IBAction func onPolicy(){
        ...
        SEGAnalytics.sharedAnalytics().screen("Privacy Policy Screen")
    ...
    @IBAction func onGetStarted(){
        if gGetJSON == 1{
            ...
            SEGAnalytics.sharedAnalytics().track("Tapped Get Started on Welcome")
